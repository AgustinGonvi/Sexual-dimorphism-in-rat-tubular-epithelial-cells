---
title: "Ssexual dimorphism in single-cell tubular epithelial clusters"
Author: "AGV"
...
TubEpiC$Sex <- ifelse(TubEpiC$sample == "OCR_F", "F",
                      ifelse(TubEpiC$sample == "OCR_M", "M",
                             ifelse(TubEpiC$sample == "Old_F", "F",
                                    ifelse(TubEpiC$sample == "Old_M", "M",
                                           ifelse(TubEpiC$sample == "Young_F", "F",
                                                  ifelse(TubEpiC$sample == "Young_M", "M",
                                                         "Sex"))))))
